...
void read_serial()
{
  if (Serial.available())
  {
    ...
    // if (command == "STOP")
    //   last_command = STOP;
    // if (command == "CAM_PAN_LEFT")
    //   last_command = CAM_PAN_LEFT;
    // if (command == "CAM_PAN_RIGHT")
    //   last_command = CAM_PAN_RIGHT;
    // if (command == "CAM_SNAP_LEFT")
    //   last_command = CAM_SNAP_LEFT;
    // if (command == "CAM_SNAP_CENTER")
    //   last_command = CAM_SNAP_CENTER;
    // if (command == "CAM_SNAP_RIGHT")
    //   last_command = CAM_SNAP_RIGHT;


    int cam_pos = cam_servo.read();
    int new_pos;
