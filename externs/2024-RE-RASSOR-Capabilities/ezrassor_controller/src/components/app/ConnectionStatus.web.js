            ...
            <View style={{ height: '100%', flex: 1 }} >
                ...
                <View style={ControllerStyle.screenLayout} >
                    ...
                    <View style={[ControllerStyle.title, { marginTop: '15%' }]}>
                        <Text adjustsFontSizeToFit={false} numberOfLines={1} fontSize={'3.5vw'} style={[ControllerStyle.titleText, { justifyContent: 'center' }]}>
                            RE-RASSOR Connect
                        </Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'column', justifyContent: 'space-between' }}>
                        ...
                        <View backgroundColor='#FFFFFF' width='80%' justifyContent='space-between' style={ControllerStyle.containerTwo}>
                            <Image source={this.state.screens[this.state.screen].img} style={{ width: '15%', height: '15%', resizeMode: 'contain', tintColor: 'rgba(255,255,255,1', margin: '10%' }} />
