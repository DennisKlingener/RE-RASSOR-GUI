    ...
    return (
      <View style={ControllerStyle.screenLayout} >
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: '2%' }}>
          ...
          {/* FSI logo. */}
          <Image source={logo} style={[ControllerStyle.fsiLogo, {height: '45%', alignSelf: 'center', justifyContent: 'center', marginTop: '3%'}]} />
		...
		<Pressable
          ...
          >
            <Text adjustsFontSizeToFit={true} numberOfLines={1} style={[ControllerStyle.buttonText, {fontSize: '2vw'}]}>
              Back
            </Text>
          </Pressable>
